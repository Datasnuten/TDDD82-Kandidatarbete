...
package org.osmf.net.httpstreaming.f4f
{
	...
	public class AdobeBootstrapBox extends FullBox
	{
		...
		public function get totalDuration():uint
		{
			...
			CONFIG::LOGGING
			{
				logger.debug("TOTDURPAT total duration: " + ((_currentMediaTime - (frt.fragmentDurationPairs)[0].durationAccrued) / 1000 ) + " seconds");
				logger.debug("TOTDURPAT media time: " + _currentMediaTime);
				logger.debug("TOTDURPAT accrued duration: " + (frt.fragmentDurationPairs)[0].durationAccrued);
			}
		...
		CONFIG::LOGGING
		{
			private static const logger:org.osmf.logging.Logger = org.osmf.logging.Log.getLogger("org.osmf.net.httpstreaming.f4f.AdobeBottstraptBox");
		}
	}
}