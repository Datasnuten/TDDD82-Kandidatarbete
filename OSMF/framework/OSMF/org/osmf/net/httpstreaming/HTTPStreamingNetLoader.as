...
package org.osmf.net.httpstreaming
{
	...
	{
		private static const logger:org.osmf.logging.Logger = org.osmf.logging.Log.getLogger("org.osmf.net.httpstreaming.HTTPstreamingNetLoader");
		/**
		 * Constructor.
		 *  
		 *  @langversion 3.0
...
//			HTTPStreamDownloader.passNetstream(httpNetStream);
//			var httpDownloadManager:HTTPDownloadManager=new HTTPDownloadManager(httpNetStream);		//last working
				
//			CONFIG::LOGGING
//			{
//				logger.debug("branchleft trait " + httpNetStream);
//			}
		...
		//	for (var k:Object in loadTrait.) { //loadTrait.traits
		//		var value:MediaTraitBase=dictionary[k]; 
		//		var key:KeyType=k; 
				// do stuff 
		//	} 
