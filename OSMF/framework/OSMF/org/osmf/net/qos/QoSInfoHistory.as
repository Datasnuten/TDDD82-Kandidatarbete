...
package org.osmf.net.qos
{
	...
	public class QoSInfoHistory
	{
		...
		internal function addQoSInfo(qosInfo:QoSInfo):void
		{
			...
			logger.debug("PATQOS " + qosInfo.lastDownloadedFragmentDetails.fragmentIdentifier + " " + qosInfo.lastDownloadedFragmentDetails.size+ " "+ qosInfo.lastDownloadedFragmentDetails.index+ " "+ qosInfo.lastDownloadedFragmentDetails.downloadDuration);
