...
//		public function lastfrag():Number
//		{
//			var fd:FragmentDetails = lastDownloadedFragmentDetails;
//			var max:int = fd.fragmentIdentifier.length;
//			lastfragment = fd.fragmentIdentifier.substring(max-1,max);
//			return Number(lastfragment);
//			logger.info("last frag " + lastfragment);
//		}
...
//					lastfragment = fd.fragmentIdentifier.substring(max-1,max);
//					logger.info("last frag " + lastfragment);
//					filedown.playedBranch(lastfragment);
				}
...
//		private var filedown:HTTPDownloadManager = new HTTPDownloadManager(null);
