...
package org.osmf.net
{
	...
	{
		private static const logger:org.osmf.logging.Logger = org.osmf.logging.Log.getLogger("org.osmf.net.httpstreaming.HTTPSeekTrait");
		/**
		 * Constructor.
		 *  
		 *  @langversion 3.0
		...
		public function NetStreamSeekTrait(temporal:TimeTrait, loadTrait:LoadTrait, netStream:NetStream, videoSurface:VideoSurface=null)
		{
			...
			/*var httpDownloadManager:HTTPDownloadManager=new HTTPDownloadManager(netStream);
			CONFIG::LOGGING
			{
				logger.debug("branchleft trait " + netStream);
			}*/
