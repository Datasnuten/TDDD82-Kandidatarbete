...
package org.osmf.player.chrome
{
	...
	public class AssetsProvider extends EventDispatcher
	{
		...
		{				
			...
			// Added
			//#######################
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_RIGHT, ASSET_jump_right);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_LEFT, ASSET_jump_left);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_1, ASSET_jump1);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_2, ASSET_jump2);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_3, ASSET_jump3);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_4, ASSET_jump4);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_5, ASSET_jump5);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_6, ASSET_jump6);
			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_7, ASSET_jump7);
...
//			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_RIGHT_ALTERNATE, ASSET_next_selected);
//			addEmbeddedSymbol(AssetIDs.JUMP_BUTTON_LEFT_ALTERNATE, ASSET_previous_selected);
