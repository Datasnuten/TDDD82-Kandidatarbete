...
package org.osmf.player.chrome
{
	...
	public class ControlBar extends AutoHideWidget implements IControlBar
	{
		...
		override public function configure(xml:XML, assetManager:AssetsManager):void
		{
			...
			leftControls.addChildWidget(jumpButton);
			
			// Multi-jump button ADDED#######################################################
			var multijumpButton:MultiJumpButton = MultiJumpButton.getInstance();
			multijumpButton.layoutMetadata.verticalAlign = VerticalAlign.MIDDLE
			multijumpButton.layoutMetadata.horizontalAlign = HorizontalAlign.LEFT;
			multijumpButton.layoutMetadata.height = 16;
		...
		private function configureWidgets(widgets:Array):void
		{
			...
			{
				if (widget)// && !(widget is MultiJumpButton))	// Added special for the multijumpbutton
				{
