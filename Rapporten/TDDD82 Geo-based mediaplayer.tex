...
\begin{figure}[ht!]
\begin{center}
	\includegraphics[scale=0.6]{Google_Maps.png}
...
\begin{figure}[ht!]
\begin{center}
	\includegraphics[scale=0.43]{TestfallGeomap.png}
...
\begin{figure}[ht!]
\begin{center}
	\includegraphics[scale=0.36]{Hoverboard_1.png}
	\caption{Test view 1}
	\label{fig:googlemaps}
\end{center}
\end{figure}
...
\begin{figure}[ht!]
\begin{center}
	\includegraphics[scale=0.36]{Hoverboard_2.png}
	\caption{Test view 2}
	\label{fig:testfallgeomap}
\end{center}
\end{figure}
...
%Attempting to make the geo-map switching seamless.
